...
class TradingStrategy:
    ...
    def aggregate_data(self):
        ...
        file_exists = os.path.exists('ohlc_minutes.csv')
    ...
    def analyze_data(self):
        ...
        print("check is data empty: ", len(self.data))
        if not self.data.empty:
            ...
            print("REVIEW11111: ", self.data)
            print("check columns: ", self.data.columns)

            test_data = self.data[feature_set]
            print("123test_data: ", test_data)
